...
public class ClientServiceImpl implements ClientService {
    ...
    public String addRating(RatingRequest ratingRequest, String email){
        ...
        Specialist specialist = specialistRepository.findById(ratingRequest.getSpecialistId())
                .orElseThrow(() -> new IllegalStateException("no such specialist with id " + ratingRequest.toString()));


        Optional<Rating> rating = ratingRepository.findByClientIdAndSpecialistId(client.getId(), specialist.getId());
        ...
        if(rating.isPresent()){
            ...
            newRating.setSpecialist(specialist);
